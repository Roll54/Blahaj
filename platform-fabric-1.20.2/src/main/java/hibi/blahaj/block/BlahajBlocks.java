...
public class BlahajBlocks {
	...
	public static void register() {
		...
		BLAVINGAD_ITEM = Registry.register(Registries.ITEM, BLAVINGAD_ID, new CuddlyItem(BLAHAJ_BLOCK, new Item.Settings().maxCount(1), "block.blahaj.blue_whale.tooltip"));
	...
	public static void registerClient() {
		...
		BlockRenderLayerMap.INSTANCE.putBlock(BLAVINGAD_BLOCK, RenderLayer.getCutout());
